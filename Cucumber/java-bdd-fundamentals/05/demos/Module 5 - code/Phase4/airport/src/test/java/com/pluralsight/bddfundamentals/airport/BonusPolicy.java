...
public class BonusPolicy {
    ...
    public void whenTheUsualPassengerTravelsMileageAndMileageAndMileage(@Named("mileage1") int mileage1, @Named("mileage2") int mileage2, @Named("mileage3") int mileage3) {
